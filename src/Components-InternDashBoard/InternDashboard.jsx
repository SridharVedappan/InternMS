        ...
        <div className="Content-nav">
          <div className="navbar-left">
            <div className="menu-icon" onClick={() => setShow(!Show)}>
              <img src={hamburgerMenu} alt="abdmore" style={{ width: "24.06px", height: "24.06px", color: "#003073", cursor: "pointer"}}/>
            </div>
          ...
          <div className="navbar-right">
            <div className="search-box">
              <span className="search-icon">
                <img src={Search} alt="abdsearch" style={{ width: "25.06px", height: "25.06" }}/>
              </span>
              <input type="text" placeholder="Search anything....." />
            </div>
            <div className="notification-icon">
              <img src={notification} alt="abdnotification" style={{ width: "16px", height: "20px" }}/>
            ...
            <div className="profile-section-IDB">
              ...
              <div className="dropdown-icon-IDB">
                <img src={downArrow} alt="ADBarrow" />
              </div>
            </div>
          </div>
        </div>
