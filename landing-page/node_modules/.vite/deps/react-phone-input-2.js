	...
	module.exports = function(e) {
		...
		function(e, t, r) {
			(function(t) {
				...
				function b(e) {
					...
					}(e)) === Infinity || e === -Infinity ? 17976931348623157e292 * (e < 0 ? -1 : 1) : e == e ? e : 0 : 0 === e ? e : 0;
				}
		...
		function(e, t, r) {
			(function(e, r) {
				...
				function ve(e, t, r, u, c) {
					return e === t || (null == e || null == t || !$e(e) && !Ve(t) ? e != e && t != t : function(e, t, r, u, c, s) {
						...
						if (y && !h) return s || (s = new le()), l || Ue(e) ? je(e, t, r, u, c, s) : function(e, t, r, n, o, u, c) {
							switch (r) {
								...
								case i:
									...
									return c.delete(e), d;
								case "[object Symbol]": if (ae) return ae.call(e) == ae.call(t);
							}
							return !1;
						}(e, t, d, r, u, c, s);
						if (!(2 & c)) {
						...
						return s || (s = new le()), function(e, t, r, n, a, o) {
							var i = 2 & a, u = qe(e), c = u.length;
							if (c != qe(t).length && !i) return !1;
							var l = c;
							for (; l--;) {
								var f = u[l];
				...
				(q && "[object DataView]" != Oe(new q(/* @__PURE__ */ new ArrayBuffer(1))) || H && Oe(new H()) != a || W && "[object Promise]" != Oe(W.resolve()) || J && Oe(new J()) != i || Z && "[object WeakMap]" != Oe(new Z())) && (Oe = function(e) {
			...
			var P = function e(t, r, n, a, i, u, s, l, f, d, p, h, m, y) {
				...
				function t(e) {
					...
					c(this, t), (r = function(e, t) {
						...
						r.numberInputRef && r.numberInputRef.value === r.props.prefix && r.state.selectedCountry && !r.props.disableCountryCode && r.setState({ formattedNumber: r.props.prefix + r.state.selectedCountry.dialCode }, (function() {
							r.props.jumpCursorToEnd && setTimeout(r.cursorToEnd, 0);
						})), r.setState({ placeholder: "" }), r.props.onFocus && r.props.onFocus(e, r.getCountryData()), r.props.jumpCursorToEnd && setTimeout(r.cursorToEnd, 0);
						...
						if (r.state.showDropdown && !r.props.disabled && (!n.includes("search-box") || e.which === t.UP || e.which === t.DOWN || e.which === t.ENTER || e.which === t.ESC && "" === e.target.value)) {
							...
							switch (e.which) {
								...
								case t.TAB:
									...
									break;
								default: (e.which >= t.A && e.which <= t.Z || e.which === t.SPACE) && r.setState({ queryString: r.state.queryString + String.fromCharCode(e.which) }, r.state.debouncedQueryStingSearcher);
							}
						}
						...
						var e = r.state, t = e.preferredCountries, a = e.highlightCountryIndex, o = e.showDropdown, i = e.searchValue, u = r.props, c = u.disableDropdown, s = u.prefix, l = r.props, f = l.enableSearch, d = l.searchNotFound, p = l.disableSearchIcon, h = l.searchClass, m = l.searchStyle, b = l.searchPlaceholder, g = l.autocompleteSearch, v = r.getSearchFilteredCountries().map((function(e, t) {
							...
							return y.a.createElement("li", Object.assign({
								...
								role: "option"
							}, n ? { "aria-selected": !0 } : {}), y.a.createElement("div", { className: i }), y.a.createElement("span", { className: "country-name" }, r.getDropdownCountryName(e)), y.a.createElement("span", { className: "dial-code" }, e.format ? r.formatNumber(e.dialCode, e) : s + e.dialCode));
						...
						return y.a.createElement("ul", {
							...
							role: "listbox",
							tabIndex: "0"
						}, f && y.a.createElement("li", { className: N()(n({ search: !0 }, h, h)) }, !p && y.a.createElement("span", {
							className: N()(n({ "search-emoji": !0 }, "".concat(h, "-emoji"), h)),
							role: "img",
				...
				return function(e, t) {
					...
					},
					{
						...
						value: function() {
							...
							return y.a.createElement("div", {
							...
							}, b && y.a.createElement("div", { className: "special-label" }, b), r && y.a.createElement("div", { className: "invalid-number-message" }, r), y.a.createElement("input", Object.assign({
								className: _,
								...
								type: "tel"
							}, this.props.inputProps, { ref: function(e) {
							...
							}, p ? y.a.createElement("div", { className: w }, p) : y.a.createElement("div", {
							...
							}, y.a.createElement("div", { className: j }, !d && y.a.createElement("div", { className: C }))), c && this.getCountryDropdownList()));
						}
					}
